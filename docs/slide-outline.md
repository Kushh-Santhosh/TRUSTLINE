...
> **Accuracy note:** this is a presentation outline, not implementation authority. Slides must distinguish implemented controls from mock demonstrations and current limitations; see [README.md](../README.md).
...
**Speaker note:** _"If you can't answer 'prove the approval happened', you've built a dashboard, not a security system."_
...
**Speaker note:** _"I'm switching to the app now."_ Do not narrate the slide — switch immediately.
...
**Speaker note:** _"Knowing what not to build is engineering judgment. Every one of these was considered and rejected for a specific reason."_
...
**Speaker note:** End with _"Questions?"_ and pull up the terminal — ready to run `npm run verify-chain` or `npm run smoke-test` if a judge wants to probe.
